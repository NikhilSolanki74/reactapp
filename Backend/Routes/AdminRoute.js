...
const {getAdminData,removeAccount,edituser, getRegisteredUser,getChart, getLine, getEngagmentTime,getLineBar,getRegisteredSeller} = require('../Controller/adminController');
...
router.post('/getregisteredseller',getRegisteredSeller)
